...
// Setup Theme
add_action( 'after_setup_theme', 'vds_setup' );
function vds_setup(): void {
	 ...
	 */
	load_theme_textdomain( 'vds', get_parent_theme_file_path( '/languages' ) );
    ...
    register_nav_menus(
        array(
            'primary'   => esc_html__('Primary Menu', 'vds'),
        )
    );

...
class vds_recent_post_widget extends WP_Widget {
	/* Widget setup */
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'recent-post-widget',
			'description' => esc_html__( 'A widget show post', 'vds' ),
		);
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Recent Post', 'vds'),
			'order' => 'DESC'
		);
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>">
				<?php esc_attr_e( 'Select Categories:', 'vds' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>"
                ...
                <option value="0" <?php echo( in_array( 0, $select_cat ) ? 'selected="selected"' : '' ); ?>>
					<?php esc_html_e( 'All Category', 'vds' ); ?>
                </option>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
				<?php esc_html_e( 'Number of posts to show:', 'vds' ); ?>
            </label>
...
// Register widget
function vds_recent_post_widget_register() {
	register_widget( 'vds_recent_post_widget' );
}

add_action( 'widgets_init', 'vds_recent_post_widget_register' );
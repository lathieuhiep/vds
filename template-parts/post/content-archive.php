<?php
$sidebar = vds_get_option('opt_post_cat_sidebar_position', 'right');
$per_row = vds_get_option('opt_post_cat_per_row', '2');

$class_col_content = vds_col_use_sidebar($sidebar, 'sidebar-main');
